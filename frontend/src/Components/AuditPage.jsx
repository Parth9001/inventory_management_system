...
export default function AuditPageBar() {
  return (
    ...
    <div style={{width: 114, height: 34, left: 804, top: 8, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 30, fontFamily: 'Garamond', fontWeight: '700', wordWrap: 'break-word'}}>Quantity</div>

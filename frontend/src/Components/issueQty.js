...
function IssueQty() {
  ...
  return (
    <div style={{ width: 250, height: 86, position: 'absolute', left: 680, top: 432 }}>
      <div style={{ width: 250, height: 50, position: 'absolute', left: 0, top: 40, background: 'white', borderRadius: 30, border: '3px #042453 solid' }} />
      <div style={{ left: 88, top: 45, position: 'absolute', color: '#4C7ED5', fontSize: 24, fontFamily: 'Garamond', fontWeight: '700' }}>
      ...
      <div style={{ width: 194, height: 34, left: 28, top: 0, position: 'absolute', textAlign: 'center', color: '#042453', fontSize: 30, fontFamily: 'Garamond', fontWeight: '700', marginBottom:'1%'}}>Quantity</div>
    </div>
  );
}

export default IssueQty;
